...
%% Make folder and set filePath
    ...
    EIT_V_Filepath = '.\EIT_LCT_Normal1_FER_Voltage';

    if ~exist('.\EIT_LCT_Normal1_FER_CP','dir')
        mkdir('.\EIT_LCT_Normal1_FER_CP');
    end
    EIT_CP_Filepath = '.\EIT_LCT_Normal1_FER_CP';
