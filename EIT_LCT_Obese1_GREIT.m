function EIT_LCT_Obese1_GREIT()
%% Make folder and set filePath
    if ~exist('.\EIT_LCT_Obese1_GREIT','dir')
        mkdir('.\EIT_LCT_Obese1_GREIT');
    end
    EIT_GREIT_Filepath = '.\EIT_LCT_Obese1_GREIT';

    if ~exist('.\EIT_LCT_Obese1_GREIT_Voltage','dir')
        mkdir('.\EIT_LCT_Obese1_GREIT_Voltage');
    end
    EIT_V_Filepath = '.\EIT_LCT_Obese1_GREIT_Voltage';

    if ~exist('.\EIT_LCT_Obese1_GREIT_CP','dir')
        mkdir('.\EIT_LCT_Obese1_GREIT_CP');
    end
    EIT_CP_Filepath = '.\EIT_LCT_Obese1_GREIT_CP';
...
%% Run GREIT and save EIT data during sine TV wave
        for iter = 1:sigmaLen
            ...
            imgPath = [EIT_GREIT_Filepath '\EIT_LCT_Obese1_GREIT_collapse_case_' num2str(collapseCase) '_' num2str(iter) '.png'];
